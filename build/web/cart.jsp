<% if (session.getAttribute("acc")==null) { response.sendRedirect("login"); return; } %>
                ...
                <body>
                            ...
                            <tbody>
                                <c:if test="${not empty param.product_name}">
                                    <tr>
                                        ...
                                        <td>
                                            <fmt:formatNumber type="currency" currencyCode="VND"
                                                value="${param.price * param.quantity}" />
                                        </td>
                                    </tr>
                                </c:if>
                            </tbody>
                    ...
                    <section id="newsletter" class="section-p1 section-m1">
                        <div class="newtext">
                            ...
                            <p>Nhận email cập nhật mới nhất về cửa hàng và <span>các ưu đãi đặc biệt của chúng
                                    tôi.</span> </p>
                        </div>
                        <div class="form">
