    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <script>
                    // Dữ liệu truyền từ CSDL
                    const labels = [
                        <c:forEach var="revenue" items="${monthlyRevenueList}" varStatus="loop">
                            `"Tháng ${revenue.month}/${revenue.year}"`<c:if test="${!loop.last}">,</c:if>
                        </c:forEach>
                    ];
                
                    const data = [
                        <c:forEach var="revenue" items="${monthlyRevenueList}" varStatus="loop">
                            ${revenue.revenue}<c:if test="${!loop.last}">,</c:if>
                        </c:forEach>
                    ];
                </script>
            </head>
