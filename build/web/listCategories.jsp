<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body class="sb-nav-fixed">
            ...
            <c:if test="${param.message == 'addCategorySuccess'}">
                <script>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn-edit card mb-4">
                                                        <a href="updateCategory?category_id=${c.category_id}">
                                                            <i class="fa-solid fa-pen-to-square"></i> Sửa
                                                        </a>
                                                    </button>

                                                    <button class="btn-delete card mb-4">
                                                        <a onclick="return confirm('bạn có muốn xóa danh mục hàng này không?');"
                                                            href="deleteCategory?category_id=${c.category_id}">
                    ...
                    <div class="modal-body">
                        <form action="addCategory" method="post">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="modal-input" placeholder="Nhập tên Danh Mục"
