<%@page contentType="text/html" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body class="sb-nav-fixed">
            ...
            <c:if test="${param.message == 'addStockSuccess'}">
                <script>
                    window.onload = function () {
                        alert("Thêm số lượng hàng tồn kho thành công!");
                    }
                </script>
            </c:if>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn-edit card mb-4">
                                                        <a href="updateWarehouse?product_size_id=${ps.product_size_id}">
                                                            <i class="fa-solid fa-pen-to-square"></i> Sửa
                                                        </a>
                                                    </button>

                                                    <button class="btn-delete card mb-4">
                                                        <a onclick="return confirm('bạn có muốn xóa size giày này không?');"
                                                            href="deleteProductSize?product_size_id=${ps.product_size_id}">
                    ...
                    <div class="modal-body">
                        <form action="addStockQuantity" method="post">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="modal-input" placeholder="Nhập size sản phẩm" name="Psize"
                                    required>
                            </div>

                            <div class="mb-3">
                                <label for="quantity" class="modal-lable">Số lượng:</label>
                                <input type="text" class="modal-input" placeholder="Nhập số lượng hàng"
